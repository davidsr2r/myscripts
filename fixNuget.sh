## Fixes a corrupted Nuget cache by blasting it to high heaven.

# Check required assumptions before running, give option to exit
while true; do
    ...
    case $yn in
        ...
        [Nn]* ) echo "You need to do those 3 things before running this script" ; exit;;
